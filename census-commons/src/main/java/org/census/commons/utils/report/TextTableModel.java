...
// todo: implement meta header for text output format

public final class TextTableModel {

    private String     metaHeader = null; // meta header for table (placed on all columns)
    private String[]   header     = null; // data table header (header for every column)
    private String[][] data       = null; // data table rows (column by column)

    /** Constructor. */
    public TextTableModel(String metaHeader, String[] header, String[][] data) {
        // adding meta header
