...
insert into auth_user_role(user_id, role_id) values(1, 1); -- Test user -> user
insert into auth_user_role(user_id, role_id) values(2, 1); -- Dmitrii -> user
insert into auth_user_role(user_id, role_id) values(2, 2); -- Dmitrii -> admin
