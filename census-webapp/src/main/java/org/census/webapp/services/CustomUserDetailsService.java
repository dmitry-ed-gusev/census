...
/**
 * A custom service for retrieving users from a custom datasource, such as a database. This custom service must
 * implement Spring's {@link UserDetailsService}
...
public class CustomUserDetailsService implements UserDetailsService {
 ...
 public UserDetails loadUserByUsername(String username)
  ...
  try {
   ...
   // DbUser is our custom dto user. This is not the same as Spring's User
