...
<!-- МЕНЮ -->    
    ...
    <div id="my_menu" class="sdmenu">
        ...
        <a href="http://www.rs-head.spb.ru"><b  class="sdmenu3">Официальный сайт</b></a>

        <a href="http://info.rs-head.spb.ru"><b  class="sdmenu3">Сайт судовладельцев</b></a>

        <a href="http://gur.rs-head.spb.ru/win/e-mail/index.htm"><b  class="sdmenu3">Контакты</b></a>

        <a href="http://gur.rs-head.spb.ru"><b  class="sdmenu3">Сайт для персонала</b></a>
